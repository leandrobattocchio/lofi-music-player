...
export const AmbientSound = ({ ambientSound, label, Icon }) => {
    ...
    return (
        <div className='flex justify-center items-start cursor-pointer group' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
            ...
            <div className='ml-3'>
                <div className={`${isShow ? 'popping' : 'hiding'} text-xs flex flex-col justify-center items-center absolute bg-gray-900 bg-opacity-50 px-2 py-1 rounded transition-transform`}>
